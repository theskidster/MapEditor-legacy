...
final class Geometry {
    ...
    Geometry(float x, float y, float z) {
        ...
        To reduce the number of draw calls generated by level geometry I'll 
        implement ways to extend existing mesh by providing it with addtional
        vertices/faces.
        
        - Add geometry tool
        - Add face/vertex manipulation
        
        - Add similar mesh manipulation tools for bounding volumes
        */
