...
public class WidgetMBView extends Widget {
    ...
    public WidgetMBView() {
        ...
        nkRectangles[0].w(CONTENT_X * 2);
        nkRectangles[0].h(MB_HEIGHT * 30);
        ...
        try(MemoryStack stack = MemoryStack.stackPush()) {
            ...
            if(nk_begin(nkContext, title, nkRectangles[0], NK_WINDOW_NO_SCROLLBAR)) {
                ...
                if(hovered) {
                    ...
                    if(!((WidgetMenuBar) widgets.get("Menu Bar")).getActiveMenu(2)) {
                        removeRequest = true;
                    }
                }
            }
